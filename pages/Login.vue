<template>
  <div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-5">
        <div class="card">
          <div class="Merhaba" style="text-align: center;">
          ...
          <div class="card-header text-center">
            <div class="d-flex justify-content-between">
              <!-- Giriş Yap Button -->
              <button class="btn border" style="background-color: white; color: black; width: 48%; font-weight: bolder;"
                @click="isSignUp = false">
                Giriş Yap
              </button>
              <!-- Üye Ol Button -->
              <button class="btn border" :class="{ active: isSignUp }"
                style="background-color: white; color: black; width: 48%; font-weight: bolder;"
                @click="isSignUp = true">
                Üye Ol
              </button>
            </div>
...
.d-flex button {
  width: 30%;
  /* Sosyal butonlar için genişliği ayarlıyoruz */
}
